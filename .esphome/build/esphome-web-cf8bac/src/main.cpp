...
void setup() {
  ...
  //   {}
  // esphome:
  //   name: esphome-web-cf8bac
  //   friendly_name: esphome-web-cf8bac
  //   build_path: build/esphome-web-cf8bac
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  ...
  App.pre_setup("esphome-web-cf8bac", "esphome-web-cf8bac", "", "", __DATE__ ", " __TIME__, false);
  // switch:
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  ...
  gpio_gpioswitch->set_object_id("living_room_dehumidifier");
  gpio_gpioswitch->set_disabled_by_default(false);
  gpio_gpioswitch->set_restore_mode(switch_::SWITCH_ALWAYS_OFF);
  ...
  gpio_gpioswitch->set_pin(esp32_esp32internalgpiopin);
  // socket:
