...
void setup() {
  ...
  App.pre_setup("llll", "llll", "", "", __DATE__ ", " __TIME__, false);
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  //   tx_buffer_size: 512
  ...
  // wifi:
  //   ap:
  //     ssid: Llll Fallback Hotspot
  //     password: 2j1gH9yWNiV4
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: llll.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("llll.local");
  {
  ...
  wifi_wifiap.set_ssid("Llll Fallback Hotspot");
  wifi_wifiap.set_password("2j1gH9yWNiV4");
  ...
  // ota:
  //   password: a1e1e0d4d4f2e6bc3ec741b7528c8731
  //   id: ota_otacomponent
  //   safe_mode: true
  //   version: 2
  //   port: 3232
  ...
  ota_otacomponent->set_auth_password("a1e1e0d4d4f2e6bc3ec741b7528c8731");
  ota_otacomponent->set_component_source("ota");
  App.register_component(ota_otacomponent);
  if (ota_otacomponent->should_enter_safe_mode(10, 300000)) return;
  // api:
  //   encryption:
  //     key: 9MxD06zD/SuQDD1VXOt/uRv9xOJ84JVXhiKsIgNsnt0=
  //   id: api_apiserver
  //   port: 6053
  //   password: ''
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({244, 204, 67, 211, 172, 195, 253, 43, 144, 12, 61, 85, 92, 235, 127, 185, 27, 253, 196, 226, 124, 224, 149, 87, 134, 34, 172, 34, 3, 108, 158, 221});
  // esp32:
  //   board: esp32dev
  //   framework:
  //     version: 2.0.5
