...
mpu6050::MPU6050Component *mpu6050_mpu6050component;
...
void setup() {
  ...
  //   {}
  // esphome:
  //   name: esphome-sperimentazione-2
  //   friendly_name: esphome-sperimentazione-2
  //   build_path: build/esphome-sperimentazione-2
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  ...
  App.pre_setup("esphome-sperimentazione-2", "esphome-sperimentazione-2", "", "", __DATE__ ", " __TIME__, false);
  // text_sensor:
  // switch:
  // logger:
  //   level: VERBOSE
  ...
  sensor_lambdafilter = new sensor::LambdaFilter([=](float x) -> optional<float> {
      #line 69 "/config/esphome-finestra-roto.yaml"
      return min(max(2 * (x + 100.0), 0.0), 100.0);
  });
  ...
  //     accuracy_decimals: 2
  //     state_class: measurement
  //   id: mpu6050_mpu6050component
  //   i2c_id: i2c_arduinoi2cbus
  //   address: 0x68
  mpu6050_mpu6050component = new mpu6050::MPU6050Component();
  mpu6050_mpu6050component->set_update_interval(250);
  mpu6050_mpu6050component->set_component_source("mpu6050.sensor");
  App.register_component(mpu6050_mpu6050component);
  mpu6050_mpu6050component->set_i2c_bus(i2c_arduinoi2cbus);
  mpu6050_mpu6050component->set_i2c_address(0x68);
  ...
  mpu6050_mpu6050component->set_accel_x_sensor(accel_x);
  ...
  mpu6050_mpu6050component->set_accel_y_sensor(accel_y);
  ...
  mpu6050_mpu6050component->set_accel_z_sensor(accel_z);
  // socket:
