...
void setup() {
  ...
  //   enable_on_boot: true
  //   networks:
  //   - ssid: HouseOfTheEagle2
  //     password: marmellata1949
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: livingroom
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("livingroom");
  {
  ...
  wifi_wifiap.set_password("K7HOfFg2K32B");
