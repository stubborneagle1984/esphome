...
void setup() {
  ...
  //   friendly_name: sperimentazione
  //   build_path: build/sperimentazione
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  ...
  App.pre_setup("sperimentazione", "sperimentazione", "", "", __DATE__ ", " __TIME__, false);
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  //   tx_buffer_size: 512
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: sperimentazione.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("sperimentazione.local");
  {
  ...
  ota_otacomponent->set_auth_password("f7f53b46f6e3c43f7ddd4bd23e7c52fa");
