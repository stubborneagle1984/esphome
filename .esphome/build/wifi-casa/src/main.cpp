...
void setup() {
  ...
  App.pre_setup("wifi-casa", "wifi_casa", "", "", __DATE__ ", " __TIME__, false);
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  //   tx_buffer_size: 512
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: wifi-casa.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("wifi-casa.local");
  {
  ...
  wifi_wifiap.set_ssid("Wifi-Casa Fallback Hotspot");
  wifi_wifiap.set_password("QiAouG9T4ca5");
  ...
  ota_otacomponent->set_auth_password("50b2296751f87b30f53311e86c809803");
  ...
  api_apiserver->set_noise_psk({131, 90, 14, 19, 39, 254, 176, 148, 144, 229, 79, 72, 241, 240, 216, 181, 183, 143, 56, 166, 5, 121, 184, 79, 51, 244, 154, 50, 117, 147, 176, 205});
  // esp32:
  //   board: esp32dev
  //   framework:
  //     version: 2.0.5
