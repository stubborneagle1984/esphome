...
void setup() {
  ...
  App.pre_setup("kkkk", "kkkk", "", "", __DATE__ ", " __TIME__, false);
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  //   tx_buffer_size: 512
  ...
  // wifi:
  //   ap:
  //     ssid: Kkkk Fallback Hotspot
  //     password: pzPnj9TL3IXL
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: kkkk.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("kkkk.local");
  {
  ...
  wifi_wifiap.set_ssid("Kkkk Fallback Hotspot");
  wifi_wifiap.set_password("pzPnj9TL3IXL");
  ...
  // ota:
  //   password: 954743ea257a89fd019030cc34c1caf3
  //   id: ota_otacomponent
  //   safe_mode: true
  //   version: 2
  //   port: 3232
  ...
  ota_otacomponent->set_auth_password("954743ea257a89fd019030cc34c1caf3");
  ota_otacomponent->set_component_source("ota");
  App.register_component(ota_otacomponent);
  if (ota_otacomponent->should_enter_safe_mode(10, 300000)) return;
  // api:
  //   encryption:
  //     key: sYnexWwpzLs2cDW4ahpQqKltUBs69kCM1qxL/I3kjoQ=
  //   id: api_apiserver
  //   port: 6053
  //   password: ''
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({177, 137, 222, 197, 108, 41, 204, 187, 54, 112, 53, 184, 106, 26, 80, 168, 169, 109, 80, 27, 58, 246, 64, 140, 214, 172, 75, 252, 141, 228, 142, 132});
  // esp32:
  //   board: esp32dev
  //   framework:
  //     version: 2.0.5
